...
COUPONS = {
    ...
    "SOCIOHUNT25": {
        "discount_pct": 25,
        "description": "ProductHunt Launch — 25% off Pro Monthly",
        "applies_to": ["pro_monthly"],
        "expires_at": None,
        "active": True,
    },
    "SOCIOREDDIT15": {
        "discount_pct": 15,
        "description": "Reddit Launch — 15% off Pro Monthly",
        "applies_to": ["pro_monthly"],
        "expires_at": None,
        "active": True,
    },
    "SOCIOHACKERS15": {
        "discount_pct": 15,
        "description": "IndieHackers Launch — 15% off Pro Monthly",
        "applies_to": ["pro_monthly"],
        "expires_at": None,
        "active": True,
    },
    "SOCIOLAUNCH20": {
        "discount_pct": 20,
        "description": "Launch Special — 20% off Pro Monthly",
        "applies_to": ["pro_monthly"],
        "expires_at": None,
        "active": True,
    },
