...
export default function App() {
  ...
  const APP_ICONS = {
    ...
    pixel:    <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C12 2 13 8 18 9C18 9 24 10 22 12C22 12 18 13 18 15C18 15 17 21 12 22C12 22 7 21 6 15C6 15 6 13 2 12C2 12 0 10 6 9C6 9 11 8 12 2Z"/></svg>,
