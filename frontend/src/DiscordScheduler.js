    ...
    <div style={{display:"flex",flexDirection:"column",gap:"14px"}}>
      <div style={{display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:"10px"}}>
        {[
          ...
          {label:"MEMBERS",value:data.member_count!=null?data.member_count.toLocaleString():"N/A",sub:data.server_name||"server members"},
...
export default function DiscordScheduler({ user }) {
  ...
  return(
    <div style={{fontFamily:"'DM Sans','Syne',sans-serif",maxWidth:"860px",margin:"0 auto",padding:"20px 16px"}}>
      <style>{`@keyframes dspin{to{transform:rotate(360deg)}} *{box-sizing:border-box;margin:0}`}</style>
      ...
      {activeGuild&&(
        <div style={{display:"flex",alignItems:"center",gap:"10px",padding:"12px 16px",borderRadius:"12px",
          background:"rgba(255,255,255,0.02)",border:`1px solid ${C.hairline}`,marginBottom:"16px"}}>
